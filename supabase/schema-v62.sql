-- Meu Mercado — v62.
-- checkout() só limitava uso de cupom pelo total global (usage_limit) — a
-- mesma pessoa podia usar "BEMVINDO10" em todo pedido até bater o limite,
-- mesmo o nome do cupom sugerindo "só na primeira compra". Adiciona um
-- interruptor por cupom (ligado por padrão, já que é o caso mais comum) e a
-- checagem dentro do próprio checkout() — nunca confia em nada vindo do
-- navegador.
