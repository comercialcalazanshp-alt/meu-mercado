-- Meu Mercado — v49.
-- Endereço de entrega: faltava por completo — o checkout só perguntava o
-- bairro (pra calcular o frete), nunca a rua/número/complemento de verdade.
-- Sem isso não dava pra entregar nada além de "retirar na loja".
